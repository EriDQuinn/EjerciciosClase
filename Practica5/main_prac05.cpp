...
/*----------I pulgar --- O indice --- P medio --- J anular---- K  meñique------------*/
...
void display(void)
{
	...
	//bicep
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(1.5, 0, 0));
	modelTemp = model;//TEMPORAL
  ...
  //antebrazo
							//creando pivote
	model = glm::translate(model, glm::vec3(1, 0, 0));//pivote articulacion
	...
	//palma
	model = glm::translate(model, glm::vec3(1.5, 0, 0));//pivote articulacion
