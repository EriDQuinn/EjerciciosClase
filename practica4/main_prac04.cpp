...
void display(void)
{
	...
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3, -2.25, 0));
	...
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3.75, -4.25, 0));
	model = glm::scale(model, glm::vec3(.5, 3, 1));//escalas
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.0f, 0.9f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //brazo
