...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(.80f, .60f, 0.7f));
	sphere_draw();
	model = glm::mat4(1.0f);	//mercurio
	//luna
	/*model = glm::rotate(model, glm::radians(-mercurio*10), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(1.5, 0, 0));
	model = glm::rotate(model, glm::radians(mercurio*3), glm::vec3(0.1f, 0.1f, 0.1f));
	model = glm::scale(model, glm::vec3(0.10f, 0.10f, .10f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.9f, 0.3f));
	sphere_draw();*/
	//anillos
	/*model = glm::scale(model, glm::vec3(0.8f, .80f, .80f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.9f, 0.3f));
	sphere_draw();*/
	//venus
	model = glm::rotate(model, glm::radians(venus), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(4, 0, 0));
	model = glm::rotate(model, glm::radians(venus), glm::vec3(0.1f, 0.1f, 0.1f));
	model = glm::scale(model, glm::vec3(0.60f, 0.60f, .60f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.70f, 0.36f, 0.3f));
	sphere_draw();
	model = glm::mat4(1.0f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.94f, 1.0f));
	sphere_draw();
	model = temp01;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.80f, 0.4f, 0.7f));
	sphere_draw();
	model = temp01;
	...
	model = glm::scale(model, glm::vec3(0.20f, 0.20f, .20f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.1f, 0.27f, 0.39f));
	sphere_draw();
	model = temp01;
	...
	model = glm::scale(model, glm::vec3(0.150f, 0.150f, .150f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.75f, 0.5f, 0.16f));
	sphere_draw();
	model = temp01;
	//luna6
	model = glm::rotate(model, glm::radians(luna2), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	model = glm::scale(model, glm::vec3(0.20f, 0.20f, .20f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.11f, 0.12f, 0.31f));
	sphere_draw();
	model = temp01;
	//luna7
	model = glm::rotate(model, glm::radians(luna), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	model = glm::scale(model, glm::vec3(0.150f, 0.150f, .150f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.37f, 0.55f, 0.65f));
	sphere_draw();
	model = glm::mat4(1.0f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(.970f, 0.8f, 0.75f));
	sphere_draw();
	model = temp01;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.990f, 0.470f, 0.960f));
	sphere_draw();
	model = temp01;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.30f, 0.68f, 0.9f));
	sphere_draw();
	model = glm::mat4(1.0f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.4f, 0.6f));
	sphere_draw();
	model = temp01;
	//luna8
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.91f, 0.12f, 0.31f));
	sphere_draw();
	model = temp01;
	//luna9
	model = glm::rotate(model, glm::radians(luna), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.37f, 0.35f, 0.65f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.3f, 0.90f));
	sphere_draw();
