...
//Instrucciones:
//Camara: mouse, scroll, A izquierda D derecha S alejar W acercar
//Manejar a Stewie:
//L guardar keyframe P reproducir animacion
// 1 y 2 mover cabeza 
// 7 levantar brazo izquierdo(hacia adelante) 8 bajar brazo(hacia atras) 
// 9 levantar brazo derecho(hacia adelante) 0 bajar brazo(hacia atras) 
//x pierna derecha hacia atras c pierna haia adelante
//n pierna izquierda hacia atras m pierna hacia adelante
//y acercar stewie   h alejar stewie
// G  Stewie a la derecha
// J  Stewie a la izquierda
...
int i_max_steps = 190;
int i_curr_steps = 0;
typedef struct _frame  //PARA GUARDAR LOS FRAMES CADA Q SE APRIETA L
{
...
bool play = false;//REPRODUCIR ANIMACION
int playIndex = 0;
...
{
	//NUEVO=SIGUIENTE-ACTUAL/NUM FRAMES
	KeyFrame[playIndex].incX = (KeyFrame[playIndex + 1].posX - KeyFrame[playIndex].posX) / i_max_steps;
	KeyFrame[playIndex].incY = (KeyFrame[playIndex + 1].posY - KeyFrame[playIndex].posY) / i_max_steps;
	KeyFrame[playIndex].incZ = (KeyFrame[playIndex + 1].posZ - KeyFrame[playIndex].posZ) / i_max_steps;
	KeyFrame[playIndex].rotIncP1 = (KeyFrame[playIndex + 1].rotRodIzq - KeyFrame[playIndex].rotRodIzq) / i_max_steps;
	KeyFrame[playIndex].rotIncP2 = (KeyFrame[playIndex + 1].rotRodDer - KeyFrame[playIndex].rotRodDer) / i_max_steps;
	
	KeyFrame[playIndex].rotIncB2 = (KeyFrame[playIndex + 1].rotHomDer - KeyFrame[playIndex].rotHomDer) / i_max_steps;
	KeyFrame[playIndex].rotIncB1 = (KeyFrame[playIndex + 1].rotHomIzq - KeyFrame[playIndex].rotHomIzq) / i_max_steps;
	
	KeyFrame[playIndex].rotIncC = (KeyFrame[playIndex + 1].rotCabeza - KeyFrame[playIndex].rotCabeza) / i_max_steps;
...
void animate(void)
{
	if (play)
	{
		...
		else
		{
			...
			rotHomIzq += KeyFrame[playIndex].rotIncB1;
			rotRodIzq += KeyFrame[playIndex].rotIncP1;
			giroMonito += KeyFrame[playIndex].giroMonitoInc;
			rotRodDer += KeyFrame[playIndex].rotIncP2;
			rotHomDer += KeyFrame[playIndex].rotIncB2;
			rotCabeza += KeyFrame[playIndex].rotIncC;
			i_curr_steps++;
		}
...
int main()
{
	...
	for (int i = 0; i < MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rotInc = 0;
		KeyFrame[i].rotIncC = 0;
		KeyFrame[i].rotIncB1 = 0;
		KeyFrame[i].rotIncB2 = 0;
		KeyFrame[i].rotIncP1 = 0;
		KeyFrame[i].rotIncP2 = 0;
